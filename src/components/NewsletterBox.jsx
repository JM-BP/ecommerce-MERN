  ...
  return (
    <div className="text-center bg-gray-400 border-y border-y-gray-700 pt-10 mb-14">
      ...
      <p className="text-gray-700 mt-3">
        ...
        ratione deleniti quis earum repudiandae iusto sequi explicabo esse alias
        dolor aliquid tempora eveniet molestiae nesciunt sint, exercitationem
        incidunt ad?
      </p>
      <form className="w-full sm:w-1/2 flex items-center gap-2 mx-auto my-6 pl-3">
        <input
          className="w-full sm:flex-1 outline-none placeholder:text-gray-400"
          type="email"
